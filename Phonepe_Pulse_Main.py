...
icon = Image.open(r"C:\Users\ACER\PycharmProjects\pythonProject2\Data files\ICN.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Tabish Ansari",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Tabish Ansari*!
